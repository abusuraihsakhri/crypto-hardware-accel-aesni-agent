"""
FastAPI REST API Server for AES-NI & ARMv8-CE Hardware Cryptographic Acceleration Auditor.
"""
...
def create_app():
    try:
        ...
        app = FastAPI(
            title="AES-NI & ARMv8-CE Hardware Cryptographic Acceleration Auditor",
            description="Benchmarks and verifies hardware-accelerated AES-GCM and SHA-256 instruction pipelines against software fallback vectors.",
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "crypto-hardware-accel-aesni-agent", "domain": "Cryptographic Engineering", "version": "2.0.0-FRONTIER"}
