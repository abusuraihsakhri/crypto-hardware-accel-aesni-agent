"""
Live WebSocket Distributed Component Telemetry Streamer for crypto-hardware-accel-aesni-agent.
"""
import json
import asyncio
...
class TelemetryBroadcaster:
    ...
    async def broadcast_event(self, event_type: str, data: Dict[str, Any]):
        msg = json.dumps({"system": "crypto-hardware-accel-aesni-agent", "event_type": event_type, "payload": data})
