...
import pytest
from crypto_accel_aesni.models import FrontierPayload, ExecutionStatus
from crypto_accel_aesni.engine import FrontierDomainEngine
from crypto_accel_aesni.agents import InstructionPipelineAgent, VectorExecutionVectorAgent, TimingUniformityAuditorAgent, HardwareCryptoCoordinator
from crypto_accel_aesni.cli import main


def test_sub_agents():
    a1 = InstructionPipelineAgent()
    ...
    a3 = TimingUniformityAuditorAgent()
...
def test_coordinator():
    coord = HardwareCryptoCoordinator()
    ...
    assert "NIST SP 800-38D (AES-GCM)" in ans or "specifications" in ans
